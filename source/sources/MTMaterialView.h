...
+(instancetype)materialViewWithRecipeNamed:(NSString *)arg1;  //iOS 14
+(instancetype)materialViewWithRecipe:(NSInteger)arg1 configuration:(NSInteger)arg2 initialWeighting:(float)arg3; //iOS 13/14
